...
function inMilliseconds() {
    return timeWithBase(time.milliseconds)
}
function inSeconds() {
    return timeWithBase(time.seconds)
}
function inMinutes() {
    return timeWithBase(time.minutes)
}
function inHours() {
    return timeWithBase(time.hours)
}
function inDays() {
    return timeWithBase(time.days)
}
function inWeeks() {
    return timeWithBase(time.weeks)
}
...
function timeWithBase(base) {
    ...
    function now(_base) {
        return Math.round(new Date().getTime() / (_base || base))
    }

    function ago(ts, yield) {
        return ago.stepFunction(ts, yield)
    }
