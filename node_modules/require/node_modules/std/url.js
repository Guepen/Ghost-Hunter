...
var URL = Class(function () {
    ...
    this.addToSearch = function (key, val) {
        this.getSearchParams()[key] = val;
        return this
    }
    this.addToHash = function (key, val) {
        this.getHashParams()[key] = val;
        return this
    }
    this.removeFromSearch = function (key) {
        delete this.getSearchParams()[key];
        return this
    }
    this.removeFromHash = function (key) {
        delete this.getHashParams()[key];
        return this
    }
...
var url = module.exports = function url(url) {
    return new URL(url)
}
url.parse = url
