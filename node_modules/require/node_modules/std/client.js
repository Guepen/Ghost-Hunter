...
var Client = Class(function () {
    ...
    this._parseBrowser = function () {
        ...
        if (this.isOpera) {
            ...
            } // Opera mini is a cloud browser - Opera/9.80 (Android 2.3.4; Linux; Opera Mobi/ADR-1110171336; U; en) Presto/2.9.201 Version/11.50
        }
    ...
    this._parseDevice = function () {
        ...
        if (this.isOpera && this._userAgent.match('Opera Mobi')) {
            this.isMobile = true
        } // Opera mobile is a proper mobile browser - Opera/9.80 (Android; Opera Mini/6.5.26571/ 26.1069; U; en) Presto/2.8.119 Version/10.54
        if (this.isSkyfire) {
            this.isMobile = true
        }
        if (this.isIPhone) {
        ...
        if (this.isAndroid) {
            ...
            if (this.isFirefox) {
                this.isMobile = true
            } // Firefox Android browsers do not seem to have an indication that it's a phone vs a tablet: Mozilla/5.0 (Android; Linux armv7l; rv:7.0.1) Gecko/20110928 Firefox/7.0.1 Fennec/7.0.1
        }
